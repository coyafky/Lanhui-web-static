...
> **来源**：从 `.trellis/tasks/06-21-admin-article/` 迁移（2026-06-22）
> **上位文档**：[ADMIN_SYSTEM_PRD_2026-06-21.md](./ADMIN_SYSTEM_PRD_2026-06-21.md)（当前实现状态见 `docs/SPEC/admin/articles.md`）
