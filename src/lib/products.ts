...
export const products: Product[] = [
  ...
  },
  {
    ...
    group: "light-mod",
    groupLabel: "轻改装备",
    tagline: "五段分区，为底盘关键区域增加隔护",
    cardDescription: "铝镁合金五段式护板，覆盖前后电机、电池与线束区域。",
    heroDescription:
      "按车型底盘结构匹配铝镁合金护板，为前后电机、电池与线束区域增加外部隔护。",
    audience: [
      "经常经过施工路段或砂石路面的车主",
      "希望减少底盘关键区域直接暴露的车主",
      "重视新能源车电池与电驱区域日常隔护的车主",
    ],
    values: [
      {
        title: "五段覆盖",
        description: "覆盖前电机、线束、前电池、后电池与后电机区域。",
      },
      {
        title: "铝镁合金",
        description: "使用铝镁合金主体，为原车底部增加一道外部隔护。",
      },
      {
        title: "车型适配",
        description: "结合车型、年款与底盘版本确认产品轮廓和固定位置。",
      },
      {
        title: "安装复查",
        description: "安装后检查固定点、部件间隙和异常声响。",
      },
    ],
    process: PROCESS_TEMPLATE,
  },
