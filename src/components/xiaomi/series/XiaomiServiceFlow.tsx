import { xiaomiSeriesServiceSteps } from "@/lib/xiaomi-series-services";

/**
 * 服务流程与施工边界：6 步（确认车型 → 感知与底盘确认 → 方案确认 → 保护施工 → 功能复检 → 交付养护）。
 */
export function XiaomiServiceFlow() {
  return (
    <section
      aria-labelledby="xiaomi-flow-title"
    ...
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <ol className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3">
          {xiaomiSeriesServiceSteps.map((step) => (
            <li
              key={step.step}
        ...
        <div className="mt-6 rounded-2xl bg-orange-950/20 p-5 shadow-[0_0_0_1px_oklch(0.646_0.222_41.116/0.15)]">
          <p className="text-sm text-zinc-300 leading-relaxed text-pretty">
            ...
            可为小米汽车 SU7、YU7 提供车膜、轮毂、专车脚垫和洗美养护等基础服务咨询，电动踏板、地板及其他专车项目需根据车型、版本、年款和实际安装条件确认，并非所有车型通用。
          </p>
        </div>
      </div>
    </section>
