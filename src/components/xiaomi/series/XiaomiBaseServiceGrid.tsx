...
import { xiaomiBaseServices } from "@/lib/xiaomi-series-services";
...
/**
 * 6 类基础服务（小米汽车全系均可咨询）：解决什么 / 适合谁 / 进入对应产品页。
 * 车膜类卡片包含车衣、隔热膜、改色膜 3 个子入口。
 */
export function XiaomiBaseServiceGrid() {
  return (
    <section
      aria-labelledby="xiaomi-services-title"
