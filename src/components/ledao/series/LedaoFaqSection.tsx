...
import { ledaoSeriesFaq } from "@/lib/ledao-series-services";

/**
 * FAQ 手风琴 + 底部车型咨询 CTA。
 */
export function LedaoFaqSection() {
  return (
    <section
      aria-labelledby="ledao-faq-title"
    ...
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {/* 底部咨询 CTA */}
        <div className="mt-10 rounded-3xl bg-gradient-to-br from-blue-950/40 to-zinc-900/60 p-8 shadow-[0_0_0_1px_oklch(1_0_0/0.06)] text-center sm:p-10">
          ...
          <div className="mt-6 flex flex-col items-center justify-center gap-3 sm:flex-row">
            <button
              ...
              className="inline-flex min-h-12 items-center gap-2 rounded-full bg-gradient-to-r from-blue-500 to-blue-600 px-6 text-base font-semibold text-white shadow-lg shadow-blue-500/20 transition-transform active:scale-[0.96]"
            >
