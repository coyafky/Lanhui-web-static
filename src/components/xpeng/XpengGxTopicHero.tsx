...
const SCENARIO_ANCHORS: readonly {
  ...
  { id: "appearance", label: "外观个性" },
  { id: "electric-convenience", label: "电动便利" },
  { id: "chassis", label: "底盘与行车防护" },
  { id: "screen-care", label: "屏幕保护" },
  { id: "cabin-care", label: "座舱维护" },
];

/**
 * 小鹏 GX 单车型轻改页 Hero（Server Component）
 * SPEC §4：面包屑 / 标题 / 副标 / 简介 / 统计 chips
 * 设计要点：
 * - 结构和视觉层级对齐极氪 9X 单车型页
 * - 生成图背景 + 深色遮罩，orange 主题
 * - 移动端 / 平板 / 桌面三视口正常
 */
    ...
    <section className="relative bg-zinc-950 text-white overflow-hidden">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-20 pb-12 md:pt-24 md:pb-16">
        ...
        <p className="text-base md:text-lg text-zinc-400 max-w-2xl leading-relaxed mb-6">
          热门轻改产品目录：围绕新车保护、隔热改色、电动便利、底盘保护、屏幕防护和座舱维护等日常用车场景，15 项升级项目供选择；蓝辉轻改顺德大良店到店评估、按标准流程施工。
        </p>
