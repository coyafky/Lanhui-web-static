...
/**
 * 6 类基础服务（全系小鹏均可咨询）：解决什么 / 适合谁 / 进入对应产品页。
 * 车膜类卡片包含车衣、隔热膜、改色膜 3 个子入口。
 * H2 使用问题型标题 + 直接答案段（GEO）。
 */
export function XpengBaseServiceGrid() {
  return (
    <section
      aria-labelledby="xpeng-services-title"
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="mb-8 lg:mb-10">
          ...
          <p className="mt-3 text-zinc-400 max-w-2xl text-base leading-relaxed text-pretty">
            车膜、轮毂、电动踏板、地板总成、专车脚垫和洗美养护这 6 类服务全系小鹏均可咨询。
            每类都链接到独立的专业页面，先了解清楚再决定；涉及车型结构差异的项目按车型确认。
          </p>
        </div>

        <div className="grid grid-cols-1 gap-4 md:grid-cols-2 lg:grid-cols-3">
          {xpengBaseServices.map((svc) => {
