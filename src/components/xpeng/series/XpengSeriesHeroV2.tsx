...
export function XpengSeriesHeroV2({
  breadcrumbItems,
}: {
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16 items-center">
          ...
          <div className="space-y-6">
            ...
            <p className="max-w-lg text-pretty text-base leading-relaxed text-zinc-300 sm:text-lg">
              蓝辉轻改顺德大良店为小鹏车主提供车衣、隔热膜、改色膜、轮毂、电动踏板、地板、专车脚垫与洗美养护。
              先根据用车问题选择服务，再结合车型、年款和配置确认适配。
            </p>
            ...
            <div className="flex flex-col gap-3 sm:flex-row sm:items-center pt-2">
              <button
                type="button"
                onClick={() => scrollTo("xpeng-scenarios")}
          ...
          <div className="lg:flex lg:items-center lg:justify-center">
            <BrandSeriesHeroVisual image={XPENG_SERIES_HERO_IMAGE} />
          </div>
        </div>
      </div>
    </section>
