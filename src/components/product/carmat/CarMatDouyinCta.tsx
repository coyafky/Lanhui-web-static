...
const DOUYIN_HIGHLIGHTS = [
  { icon: Droplets, label: "清洁演示" },
  { icon: Play, label: "安装过程" },
  { icon: Video, label: "实车效果" },
] as const;

export function CarMatDouyinCta() {
  return (
    <section
      aria-labelledby="carmat-douyin-title"
