...
const SCENARIO_ANCHORS: readonly {
  key: "protection" | "family_cabin" | "appearance" | "smart_screen" | "driving_protection";
  label: string;
}[] = [
...
/**
 * 理想 i8 二级页 Hero（RSC）
 * PRD §6：面包屑 → 标题 → 副标 → 统计 chip → 5 场景锚点
 * 主题色 amber
 * 无 CTA 按钮（遵循产品页不设计私有操作的模式）
 */
export function LiAutoI8Hero({
  totalProjects,
  totalScenarios,
  totalBundles,
  canonicalPath,
    ...
    <section className="relative bg-zinc-950 text-white overflow-hidden">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-20 pb-12 md:pt-24 md:pb-16">
        ...
        <p className="text-base md:text-lg text-zinc-400 max-w-2xl leading-relaxed mb-6">
          20 项热门轻改产品目录，覆盖新车保护、家庭座舱、外观个性、智能屏幕与行车防护
          5 大用车场景；蓝辉轻改顺德大良店到店评估、按标准流程施工。
        </p>
