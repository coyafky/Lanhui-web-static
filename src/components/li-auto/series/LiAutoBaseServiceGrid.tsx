...
import { liAutoBaseServices } from "@/lib/li-auto-series-services";
...
/**
 * 6 类基础服务（理想汽车全系均可咨询）：解决什么 / 适合谁 / 进入对应产品页。
 * 车膜保护卡片包含车衣、隔热膜、改色膜 3 个子入口。
 */
export function LiAutoBaseServiceGrid() {
  return (
    <section
      aria-labelledby="li-auto-services-title"
